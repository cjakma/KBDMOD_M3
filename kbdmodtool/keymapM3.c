...
unsigned char keymap_code[MAX_LAYER][MAX_COL][MAX_ROW] =  {
	...
	},
    {
		...
		{K_ESC,     K_1,    K_2,    K_3,    K_4,    K_5,    K_6,    K_7,    K_8,    K_9,    K_0,    K_MINUS,K_EQUAL,    K_BKSP,     K_INSERT,K_NONE,            K_NONE,K_NONE,K_NONE}, // COL1
		{K_TAB,     K_Q,    K_W,    K_E,    K_R,    K_T,    K_Y,    K_U,    K_I,    K_O,    K_P,    K_LBR,  K_RBR,      K_BKSLASH,  K_DEL, K_NONE,              K_NONE,K_NONE,K_NONE}, // COL2
		{K_CAPS,    K_A,    K_S,    K_D,    K_F,    K_G,    K_H,    K_J,    K_K,    K_L,    K_COLON,K_QUOTE,K_ENTER,    K_NONE,     K_NONE, K_NONE,             K_NONE,K_NONE,K_NONE}, // COL3
		{K_LSHIFT,  K_Z,    K_X,    K_C,    K_V,    K_B,    K_N,    K_M,    K_COMMA,K_DOT,  K_SLASH,K_NONE, K_RSHIFT,   K_NONE,     K_UP,   K_NONE,             K_NONE,K_NONE,K_NONE}, // COL4
		{K_LCTRL,   K_NONE, K_LALT, K_SPACE,K_FN,   K_B,    K_NONE, K_NONE, K_SPACE,K_RALT, K_NONE, K_NONE, K_NONE,     K_LEFT,     K_DOWN, K_RIGHT,            K_NONE,K_NONE,K_NONE}  // COL5
	},
	{
		...
		{K_HASH,    K_1,    K_2,    K_3,    K_4,    K_5,    K_6,    K_7,    K_8,    K_9,    K_0,    K_MINUS,K_EQUAL,    K_BKSP,     K_DEL,  K_NONE,             K_NONE,K_NONE,K_NONE}, // COL1
		{K_TAB,     K_Q,    K_W,    K_E,    K_R,    K_T,    K_Y,    K_U,    K_I,    K_O,    K_P,    K_LBR,  K_RBR,      K_BKSLASH,  K_PGUP, K_NONE,             K_NONE,K_NONE,K_NONE}, // COL2
		{K_CAPS,    K_A,    K_S,    K_D,    K_F,    K_G,    K_H,    K_J,    K_K,    K_L,    K_COLON,K_QUOTE,K_ENTER,    K_NONE,     K_NONE, K_NONE,             K_NONE,K_NONE,K_NONE}, // COL3
		{K_LSHIFT,  K_Z,    K_X,    K_C,    K_V,    K_B,    K_N,    K_M,    K_COMMA,K_DOT,  K_SLASH,K_NONE, K_RSHIFT,   K_NONE,     K_UP,   K_NONE,             K_NONE,K_NONE,K_NONE}, // COL4
	...
	{	
		...
		{K_HASH,  K_F1,     K_F2,   K_F3,	K_F4,	K_F5,   K_F6,   K_F7,   K_F8,   K_F9,   K_F10,	K_F11,  K_F12,      K_BKSP,     K_INSERT,K_NONE,            K_NONE,K_NONE,K_NONE},  // COL1
		{K_TAB,   K_M01,    K_M02,  K_M03,  K_M04,  K_LGUI,  K_M06,  K_M07,  K_M08,  K_M09,  K_M10,  K_RBR,  K_LBR,      K_BKSLASH,  K_SCRLCK,  K_NONE,             K_NONE,K_NONE,K_NONE},  // COL2
		{K_CAPS,  K_M11,    K_M12,  K_DEL,  K_M14,  K_PGUP, K_HOME,  K_M17,  K_M18,  K_M19,  K_COLON,K_QUOTE,K_ENTER,    K_NONE,     K_NONE, K_NONE,             K_NONE,K_NONE,K_NONE},  // COL3
