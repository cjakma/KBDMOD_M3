...
#endif
	DDRA	= 0x00;	// col
	DDRC	= 0xC0; // row 2, 3, 4, 5, 6, 7, 8, 9
	PORTC   = 0x3F; // LED5,6 off, COL[0-5] pull-up
#ifndef KBDMOD_M3
...
//	PORTB	= 0x0F;	// LED_VESEL, LED_PIN_PRT, LED_PIN_PAD, LED_PIN_WASD off          (00001111)
    ...
    PORTD   = 0x44; // DPpull-up(Low), Zener(pull-up), LED_SCR, LED_CAPS, LED_NUM (0ff), D-(0), D+(0)
    ...
    DDRD    = 0xF3; // DPpull-up(OUT), Zener(OUT), LED_SCR, LED_CAPS, LED_NUM (OUT), D-(INPUT), D+(INPUT)
#endif
